...
GLOBAL_LIST_INIT(cm_vending_clothing_marine, list(
		...
		list("Sandbags", 10, /obj/item/stack/sandbags_empty/half, null, VENDOR_ITEM_REGULAR),
		...
		list("SU-6 Smart Pistol", 10, /obj/item/storage/box/guncase/smartpistol, null, VENDOR_ITEM_REGULAR),
		list("M85A1 Grenade Launcher", 25, /obj/item/storage/box/guncase/m85a1, null, VENDOR_ITEM_REGULAR),
		...
		list("Webbing", 0, /obj/item/clothing/accessory/storage/webbing, null, VENDOR_ITEM_RECOMMENDED),
		list("Black Webbing", 0, /obj/item/clothing/accessory/storage/webbing/black, null, VENDOR_ITEM_RECOMMENDED),
		...
		list("Brown Webbing Vest", 0, /obj/item/clothing/accessory/storage/black_vest/brown_vest, null, VENDOR_ITEM_RECOMMENDED),
		list("Leg Pouch", 0, /obj/item/clothing/accessory/storage/black_vest/leg_pouch, null, VENDOR_ITEM_REGULAR),
		list("Leg Pouch (Black)", 0, /obj/item/clothing/accessory/storage/black_vest/black_leg_pouch, null, VENDOR_ITEM_REGULAR),
		list("Drop Pouch", 0, /obj/item/clothing/accessory/storage/droppouch, null, VENDOR_ITEM_REGULAR),
		list("Black Drop Pouch", 0, /obj/item/clothing/accessory/storage/droppouch/black, MARINE_CAN_BUY_ACCESSORY, VENDOR_ITEM_REGULAR),
		list("Shoulder Holster", 0, /obj/item/clothing/accessory/storage/holster, null, VENDOR_ITEM_REGULAR),
		list("Machete Scabbard (Full)", 0, /obj/item/storage/large_holster/machete/full, null, VENDOR_ITEM_REGULAR),
		...
		list("Sling Pouch", 0, /obj/item/storage/pouch/sling, null, VENDOR_ITEM_REGULAR),
		...
		list("OPTICS", 0, null, null, null),
		list("Medical Helmet Optic", 15, /obj/item/device/helmet_visor/medical, null, VENDOR_ITEM_REGULAR),
		list("HealthMate HUD", 15, /obj/item/clothing/glasses/hud/health, null, VENDOR_ITEM_REGULAR),
